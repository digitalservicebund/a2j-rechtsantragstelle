...
Storybook containing our components is running on [staging](https://a2j-staging.staging.tech.digitalservice.dev/) and [preview](https://a2j-preview.prod.tech.digitalservice.dev/storybook). To run it locally, use `pnpm run start:storybook`.

### More documentation

- [Adding a new service](/doc/adding-a-new-service.md)
- [Array user data](/doc/array-user-data.md)
- [Component rendering](/doc/component-rendering.md)
- [Deployment](/doc/deployment.md)
- [Static data](/doc/static-data.md)
