...
export const prozesskostenhilfeFinanzielleAngabenContext = {
  ...
  apartmentCostAloneCold: optionalMoneySchema,
  apartmentCostOwnShare: buildMoneyValidationSchema(),
  apartmentCostFull: buildMoneyValidationSchema(),
  apartmentCostFullCold: optionalMoneySchema,
  utilitiesCost: optionalMoneySchema,
  heatingCosts: optionalMoneySchema,
  utilitiesCostOwn: buildMoneyValidationSchema(),
  heatingCostsOwn: buildMoneyValidationSchema(),
