      ...
      {showGlobalControls && jsAvailable && (
        <div className="flex gap-kern-space-default my-kern-space-large">
          <Button
            ...
            aria-label={`${expandAllText}${allOpen ? ", Alle Abschnitte sind bereits aufgeklappt" : ""}`}
          />
          <Button
            look="secondary"
            onClick={collapseAll}
            ...
            aria-expanded={noneOpen ? false : true}
            className={noneOpen ? "kern-btn--disabled pointer-events-none" : ""}
            aria-label={`${collapseAllText}${noneOpen ? ", Alle Abschnitte sind bereits eingeklappt" : ""}`}
          />
        </div>
      )}
