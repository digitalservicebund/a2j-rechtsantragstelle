...
const AutoGeneratedSummary = ({
  ...
  const ariaLabelExpandAll =
    commonTranslations.common.showAll.de +
    (allOpen ? ", " + commonTranslations.common.showAllAriaLabel.de : "");

  const ariaLabelCollapseAll =
    commonTranslations.common.hideAll.de +
    (noneOpen ? ", " + commonTranslations.common.hideAllAriaLabel.de : "");
      ...
      {showGlobalControls && jsAvailable && (
        <div className="flex gap-kern-space-default my-kern-space-large">
          <Button
            look="secondary"
            onClick={expandAll}
            text={commonTranslations.common.showAll.de}
          ...
          <Button
            look="secondary"
            onClick={collapseAll}
            text={commonTranslations.common.hideAll.de}
