...
const AutoGeneratedSummary = ({
  ...
  const ariaLabelExpandAll = `${translations.autogeneratedSummary.expandAllText.de}${allOpen ? `, ${translations.autogeneratedSummary.expandAllAriaLabelText.de}` : ""}`;
  const ariaLabelCollapseAll = `${translations.autogeneratedSummary.collapseAllText.de}${noneOpen ? `, ${translations.autogeneratedSummary.collapseAllAriaLabelText.de}` : ""}`;
  return (
    <div>
      {showGlobalControls && jsAvailable && (
        <div className="flex gap-kern-space-default my-kern-space-large">
          ...
          <Button
            ...
            aria-label={ariaLabelCollapseAll}
          />
        </div>
      )}
