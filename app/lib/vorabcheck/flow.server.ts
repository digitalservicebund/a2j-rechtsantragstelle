...
import type { FormPages } from "./pages";
...
export type Context = Partial<{
  [T in string]: FormPages[T] extends { schema: any }
...
export type TransitionElement = string | ConditionalTransition;
export type FormFlow = Partial<Record<string, TransitionElement[]>>;
