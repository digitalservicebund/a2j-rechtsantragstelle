...
import AutoGeneratedSummary from "~/components/content/summaryOverview/AutoGeneratedSummary";
          ...
          >
            <div className="flex flex-col flex-1 gap-32 md:pl-0 md:pb-32! pt-0! justify-between">
              <div className="ds-stack ds-stack-40">
                ...
                {/* Auto-generated summary sections - only for PKH and BerH */}
                {autoGeneratedSections &&
                            ...
                            (box) =>
                              box.boxItems
                                ?.map((boxItem) => {
                                  ...
                                  return {
                                    question: boxItem.title || "",
                                    answer: itemValue.trim() || "Keine Angabe",
                                    editUrl: `..${box.stepId}`,
                                  };
                                })
                                .filter(
