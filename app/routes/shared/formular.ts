...
import {
  ...
  generateSummaryFromUserData,
} from "~/services/summary/autoGenerateSummary";
...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  // Only show auto-generated summary on main flow summary pages, not section-specific summaries
  const isMainSummaryPage =
    stepId.includes("zusammenfassung") &&
    !stepId.includes("-zusammenfassung/zusammenfassung");

  if (isMainSummaryPage) {
    try {
