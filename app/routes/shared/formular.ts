...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  // Only show auto-generated summary on the final summary pages
  const isFinalSummaryPage =
    pathname.endsWith("/formular/zusammenfassung") || // PKH final summary
    pathname.endsWith("/antrag/zusammenfassung"); // Beratungshilfe final summary
  console.log(pathname, isFinalSummaryPage);

  const showAutoSummaryEnabled = await isFeatureFlagEnabled("showAutoSummary");
