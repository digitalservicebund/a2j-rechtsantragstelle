...
describe("addFlightDetails", () => {
  it("should add the booking number to the pdf document", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(BOOKING_NUMBER_TEXT, {
      continued: true,
    });
  ...
  it("should add the start and end airport to the pdf document", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(START_AIRPORT_TEXT, {
      continued: true,
    });

    expect(mockDoc.text).toHaveBeenCalledWith(startAirportMock);

    expect(mockDoc.text).toHaveBeenCalledWith(END_AIRPORT_TEXT, {
      continued: true,
    });
  ...
  it("should add the zwischenstopp 1 to the pdf document", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(FIRST_AIRPORT_STOP_TEXT, {
      continued: true,
    });
  ...
  it("should add the zwischenstopp 2 to the pdf document", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(SECOND_AIRPORT_STOP_TEXT, {
      continued: true,
    });
  ...
  it("should add the zwischenstopp 3 to the pdf document", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(THIRD_AIRPORT_STOP_TEXT, {
      continued: true,
    });
