...
describe("addAirlineDetails", () => {
  ...
  it("should generate document with airline address details", () => {
    ...
    expect(mockDoc.text).toHaveBeenCalledWith(
      `${userDataMock.fluggesellschaftStrasse} ${userDataMock.fluggesellschaftHausnummer}, ${userDataMock.fluggesellschaftPostleitzahl} ${userDataMock.fluggesellschaftOrt}, ${userDataMock.fluggesellschaftLand}`,
    );
  });
});
