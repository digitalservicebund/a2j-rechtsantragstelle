...
import { context as kontopfaendungVorabcheckContext } from "~/domains/kontopfaendung/vorabcheck/context";
...
const contexts = {
  ...
  "/kontopfaendung/vorabcheck": kontopfaendungVorabcheckContext,
