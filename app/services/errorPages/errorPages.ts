...
const kernErrorPage403: StrapiContentComponent = {
...
const kernErrorPage404: StrapiContentComponent = {
  __component: "page.box",
  label: {
    __component: "basic.heading",
    text: "404",
...
const kernErrorPage500: StrapiContentComponent = {
  __component: "page.box",
  label: {
    __component: "basic.heading",
    text: "500",
...
export const ERROR_PAGES: Record<string, StrapiContentComponent[]> = {
  ...
  404: [errorPage404],
  500: [errorPage500],
  "403_kern": [kernErrorPage403],
  "404_kern": [kernErrorPage404],
  "500_kern": [kernErrorPage500],
};
