...
- use [codegen](https://playwright.dev/docs/codegen-intro) as an aid: `pnpm playwright codegen localhost:3000/kitchensink`

## Debug E2E tests in CI

To run e2e tests in debug mode: `pnpm playwright test --debug`
...
2. unzip
3. `pnpm playwright show-trace <DOWNLOAD_PATH>/data/<HASH>.zip`
