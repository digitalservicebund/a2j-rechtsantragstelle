# 15. Assessment of our Current Testing Strategy
...
- 2026-01-27: Edited (Changed pre-commit to pre-push)
...
Lefthook is used also to enforce pre-push `vitest` test runs. Failing unit, integration or component tests will prevent broken code from reaching the online branch.
